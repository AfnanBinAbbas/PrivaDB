...
export const TrackerDomains: React.FC = () => {
  ...
  return (
    <section id="trackers" className="py-24 px-4 relative z-10">
      <motion.div
      ...
      >
        ...
        {/* Domain grid */}
        <motion.div
          className="glass rounded-2xl p-6 max-h-80 overflow-y-auto"
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
            {filtered.slice(0, 100).map((t, i) => (
              ...
              >
                <span className={`w-2 h-2 rounded-full ${t.category === 'Analytics' ? 'bg-blue-500' :
