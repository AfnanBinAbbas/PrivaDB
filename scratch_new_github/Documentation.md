...
- `--iterations N` — Number of crawl iterations per site
- `--output FILE` — Path to a file where terminal output will be saved
- `--all` — Run full automated pipeline (implies `--overwrite` and `--output`)
